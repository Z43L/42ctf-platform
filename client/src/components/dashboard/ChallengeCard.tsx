...
export default function ChallengeCard({
  ...
  return (
    <div className="bg-background-elevated rounded-lg border border-background-subtle overflow-hidden hover:border-accent-cyan transition-colors duration-150">
      <div className="p-5">
